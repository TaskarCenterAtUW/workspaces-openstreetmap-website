...
Apartment.configure do |config|
  ...
  #
  config.tenant_names = -> {
    ActiveRecord::Base.connection.execute("SELECT schema_name FROM information_schema.schemata WHERE schema_name LIKE 'workspace-%';")
...
Rails.application.config.middleware.use WorkspacesElevator
